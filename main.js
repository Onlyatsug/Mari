var count = 0;
var botaoN = document.getElementById("nao-btn");
var botaoS = document.getElementById("sim-btn");
var maintextcount = 1;
...
function mudarPosicao() {
    ...
    switch (count) {
        case 1:
            botaoN.style.top = -140 + "px";
            botaoN.style.left = -140 + "px";
            break;
        case 2:
            botaoN.style.top = 60 + "px";
            botaoN.style.left = -140 + "px";
            break;
        case 3:
            botaoN.style.top = 60 + "px";
            botaoN.style.left = 60 + "px";
            break;
        case 4:
            botaoN.style.display = "none";
            mudarFrase("comassim vc nao vai aceitar? >:C");
            break;
    }
}

function mudarFrase(x) {
    var paragrafo = document.getElementById("ask");
    paragrafo.innerHTML = x;
}

function tomarCaldo() {
    mudarFrase("simbora<3");
    botaoN.style.display = "none";
